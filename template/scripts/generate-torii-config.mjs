 ...
 *   TORII_ARTIFACTS_DIR  ERC image cache, served at /static (default: <parent of TORII_DB_DIR>/static)
...
function toToml(networkName, net, source) {
  ...
  const artifactsDir = env.TORII_ARTIFACTS_DIR ?? join(dirname(dbDir), 'static')
